package com.max.bracelet.braceletapi.generator;
...
public class MpGenerator {
	...
	private static String url = "jdbc:mysql://localhost:3306/bracelet?useUnicode=true&characterEncoding=UTF-8&allowMultiQueries=true&serverTimezone=GMT%2B8";
